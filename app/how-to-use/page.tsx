...
export const metadata: Metadata = {
  title: 'How to Use My AI Bookkeeper - AI Bookkeeping Guide for Small Business',
  description: 'Learn how to use My AI Bookkeeper AI assistant for bookkeeping. Step-by-step guide with examples, screenshots, and prompts for small business owners.',
  keywords: [
  ...
  openGraph: {
    title: 'How to Use My AI Bookkeeper - Complete Guide',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'My AI Bookkeeper Tutorial'
      }
    ]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'How to Use My AI Bookkeeper - AI Bookkeeping Guide',
